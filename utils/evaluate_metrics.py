...
def evaluate(y_test, output, predict):
    ...
    metrics['average_precision'] = precision_score(y_test, predict,average='samples')
    metrics['average_precision_accuracy'] = accuracy_score(y_test, predict)

    metrics['average_precision_ranking'] = label_ranking_average_precision_score(y_test, output)
    metrics['average_precision_recall'] = recall_score(y_test,predict,average='samples')
